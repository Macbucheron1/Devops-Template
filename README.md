...
- [2. Apply CI/CD pipeline](#2-apply-cicd-pipeline)
  - I. [CI](#ci)
    - a. [The steps](#the-steps)
    - b. [Multiple OS support](#multiple-os-support)
    - c. [Choice justification](#choice-justification)
  - II. [CD](#cd)
    - a. [The setup](#the-setup)
    - b. [Code adaption](#code-adaption)
    - c. [The pipeline](#the-pipeline)
...
- [6. Making docker orchestration using Kubernetes](#6-making-docker-orchestration-using-kubernetes)
  ...
  - III. [Exposing the service](#2-exposing-the-service)
  - IV. [Use persistent storage](#3-use-persistent-storage)
  - V. [Usage](#4-usage)
  - VI. [Delete](#5-delete)
